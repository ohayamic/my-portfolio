    ...
    <section id="about" className="section">
      <div className="title">
        ...
        <p>
          ...
          building Websites and Applications using Flask/Django for the Backend
          with databases like Postgresql or SQL or MYSQL and HTML, CSS,
          Javascript and React.js for Frontend were the individuals (mostly
          African International in Thüringen State) can collaborate and share
          ideas in other to fight problems facing their motherland and the
